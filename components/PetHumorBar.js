    ...
    return (
        <div className="flex flex-col gap-1">
            ...
            <div className="flex gap-2 items-center py-3">
                <div className="relative h-3.5 rounded-full w-full bg-[#F46725]">
                    <div className="absolute left-1/2 top-1/2 -translate-1/2 z-10 w-6 h-6 bg-white rounded-full border-4 border-[#F46725] transition-all duration-1000 ease-in-out" style={{ opacity: petState.humor === 'angry' ? 1 : 0 }}></div>
                </div>
                <div className="relative h-3.5 rounded-full w-full bg-[#F49E14]">
                    <div className="absolute left-1/2 top-1/2 -translate-1/2 z-10 w-6 h-6 bg-white rounded-full border-4 border-[#F49E14] transition-all duration-1000 ease-in-out" style={{ opacity: petState.humor === 'sad' ? 1 : 0 }}></div>
                </div>
